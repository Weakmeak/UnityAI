...
public class NavAgent : Agent
{
    ...
    [SerializeField] NavNode pathStartNode;
    [SerializeField] NavNode pathEndNode;
    ...
    void Start()
    {
        ...
        {
            navPath.startNode = (pathStartNode != null) ? pathStartNode : GetNearestNode();
            navPath.endNode = (pathEndNode != null) ? pathEndNode : NavNode.GetRandomNode();
            navPath.StartPath();
